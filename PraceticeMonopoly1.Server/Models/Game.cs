...
namespace CustomMonopoly.Server.Models
{
    public class Game
    {
        ...
        {
            Id = 0;
            Board = ConfigureDefaultBoardSquares();
            var player = new Player(0, 1500, null, 0, 0, "0", "Blue");
            Players = new List<Player>() { player };
        }
        public List<BoardSquare> ConfigureDefaultBoardSquares()
        {
             return Board = new List<BoardSquare>()
            {
                new GoSquare(),
